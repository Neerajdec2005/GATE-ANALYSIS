...
const App: React.FC = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.get(`http://localhost:3000/students/${Regno}`);
  ...
  <a href="https://reaxt.vercel.app/" className="text-decoration-none"><span className="navbar-brand fw-bold">Exam Tracker</span></a>
  <div className="d-flex gap-3"> <br />
    <a href="#" className="text-dark text-decoration-none">Explore</a>
    <a href="#" className="text-dark text-decoration-none">Analysis</a>
